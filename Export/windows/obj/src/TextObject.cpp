...
HX_LOCAL_STACK_FRAME(_hx_pos_b340a45644fc1ab4_34_setText,"TextObject","setText",0xb782de6d,"TextObject.setText","TextObject.hx",34,0x42e92ad2)
HX_LOCAL_STACK_FRAME(_hx_pos_b340a45644fc1ab4_39_update,"TextObject","update",0x03be5ecb,"TextObject.update","TextObject.hx",39,0x42e92ad2)
...
HXLINE(  38)		this->displaySize = 0;
HXLINE(  13)		this->size = 10;
HXLINE(  12)		this->textFormat = null();
HXLINE(  11)		this->textField = null();
HXLINE(  17)		super::__construct(_hx___name,_isVisible,null());
HXLINE(  19)		this->textField =  ::openfl::text::TextField_obj::__alloc( HX_CTX );
HXLINE(  20)		this->textField->set_text(text);
HXLINE(  21)		this->size = _size;
HXLINE(  22)		this->textFormat =  ::openfl::text::TextFormat_obj::__alloc( HX_CTX ,font,this->size,color,null(),null(),null(),null(),null(),null(),null(),null(),null(),null());
HXLINE(  23)		this->textField->setTextFormat(this->textFormat,null(),null());
HXLINE(  24)		this->textField->set_autoSize(align);
HXLINE(  26)		this->addChild(this->textField);
HXLINE(  28)		this->objectType = ::ObjectType_obj::TEXT_dyn();
            	}
...
void TextObject_obj::setText(::String text){
            	HX_STACKFRAME(&_hx_pos_b340a45644fc1ab4_34_setText)
HXDLIN(  34)		this->textField->set_text(text);
            	}
...
void TextObject_obj::update( ::openfl::events::Event e){
            	HX_STACKFRAME(&_hx_pos_b340a45644fc1ab4_39_update)
HXLINE(  41)		Float _hx_tmp = (( (Float)(this->size) ) / ::Main_obj::game->mainCamera->fov->y);
HXDLIN(  41)		this->displaySize = ::Math_obj::round(((_hx_tmp * ( (Float)(::openfl::Lib_obj::get_current()->stage->window->_hx___height) )) / ( (Float)(50) )));
HXLINE(  42)		this->textFormat->size = this->displaySize;
HXLINE(  43)		this->textField->setTextFormat(this->textFormat,null(),null());
            	}
