...
HXLINE(  19)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("what",44,a3,f7,4e),::ApplicationMain_obj::create_dyn());
...
HXLINE(  38)		app->meta->set(HX_("build",2e,db,ea,ba),HX_("93",da,31,00,00));
HXLINE(  39)		app->meta->set(HX_("company",3d,15,69,83),HX_("me",58,5f,00,00));
HXLINE(  40)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("what",44,a3,f7,4e));
HXLINE(  41)		app->meta->set(HX_("name",4b,72,ff,48),HX_("what",44,a3,f7,4e));
HXLINE(  42)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("com.sample.what",5b,2a,4e,d9));
