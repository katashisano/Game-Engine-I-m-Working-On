...
HXLINE(  19)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("CUsersAlkostoDocumentsHaxeProjectsGamesTheShortAdventuresOfMaloTheWizardGame-Engine-I-m-Working-On",2c,30,d3,d4),::ApplicationMain_obj::create_dyn());
...
HXLINE(  38)		app->meta->set(HX_("build",2e,db,ea,ba),HX_("63",3d,2f,00,00));
HXLINE(  39)		app->meta->set(HX_("company",3d,15,69,83),HX_("Company Name",4e,48,0d,cb));
HXLINE(  40)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("CUsersAlkostoDocumentsHaxeProjectsGamesTheShortAdventuresOfMaloTheWizardGame-Engine-I-m-Working-On",2c,30,d3,d4));
HXLINE(  41)		app->meta->set(HX_("name",4b,72,ff,48),HX_("what",44,a3,f7,4e));
HXLINE(  42)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("com.sample.cusersalkostodocumentshaxeprojectsgamestheshortadventuresofmalothewizard",54,1e,15,77));
...
HXLINE(  49)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("what",44,a3,f7,4e))
            			...
            			->setFixed(13,HX_("frameRate",ad,11,25,39),300)
