...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("CUsersAlkostoDocumentsHaxeProjectsGamesTheShortAdventuresOfMaloTheWizardGame-Engine-I-m-Working-On", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("CUsersAlkostoDocumentsHaxeProjectsGamesTheShortAdventuresOfMaloTheWizardGame-Engine-I-m-Working-On", null, 800, 600);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "CUsersAlkostoDocumentsHaxeProjectsGamesTheShortAdventuresOfMaloTheWizardGame-Engine-I-m-Working-On";
		app.meta["name"] = "what";
